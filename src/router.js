...
const routes = [
  ...
  { path: '/login', name: 'LoginForm', component: LoginForm, meta: { hideSidebar: true } },
  { path: '/logout', name: 'Logout', component: Logout, meta: { hideSidebar: true } },
  { path: '/signup', name: 'Registration', component: Registration, meta: { hideSidebar: true } },
