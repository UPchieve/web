...
export const EVENTS = {
  ...
  STUDENT_CLICKED_TO_GET_REFERRAL_LINK_BANNER:
    'STUDENT_CLICKED_TO_GET_REFERRAL_LINK_BANNER',
  ...
  STUDENT_SHOWN_AFTER_SESSION_REFERRAL: 'STUDENT_SHOWN_AFTER_SESSION_REFERRAL',
  STUDENT_SHOWN_WAITING_SESSION_REFERRAL:
    'STUDENT_SHOWN_WAITING_SESSION_REFERRAL',
  STUDENT_SENT_EMAIL_REFERRAL: 'STUDENT_SENT_EMAIL_REFERRAL',
}
...
export const POSTHOG_FEATURE_FLAGS = {
  ...
  REFERRAL_TIMING: 'referral-timing',
}
